...
#define __GMP_CC "/Applications/Xcode10.1.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang -fembed-bitcode -isysroot /Applications/Xcode10.1.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS12.1.sdk -Wno-error -Wno-implicit-function-declaration -miphoneos-version-min=9.0 -no-integrated-as -arch arm64 -target arm64-apple-darwin"
